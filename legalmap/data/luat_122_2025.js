...
DD:[
{n:1,name:'Phạm vi điều chỉnh',kw:['kHĐT','kNTT'],
...
{n:2,name:'Đối tượng áp dụng',kw:['kHĐT'],
...
{n:3,name:'Giải thích từ ngữ',kw:['kHĐT','kNTT','kNTT2','kNTT3','kMXH','kNTT4','kCQN','kCNĐ','kCNL','kLBH','kNLB','kDVT','kTCC','kNTT5','kDVC','kHĐT2'],
...
{n:4,name:'Áp dụng Luật TMĐT và pháp luật có liên quan',kw:['kHĐT'],
...
{n:5,name:'Nguyên tắc trong hoạt động TMĐT',kw:['kHĐT','kNTT3','kMXH','kCQN'],
...
{n:6,name:'Các hành vi bị cấm trong hoạt động TMĐT',kw:['kNTT'],
...
{n:7,name:'Quản lý nhà nước về thương mại điện tử',kw:[],
...
{n:8,name:'Hợp tác quốc tế về thương mại điện tử',kw:[],
...
{n:9,name:'Chính sách của Nhà nước về phát triển TMĐT',kw:[],
...
{n:10,name:'Đối tượng, chính sách hỗ trợ đặc thù phát triển thương mại điện tử',kw:[],
...
{n:11,name:'Nội dung công khai về điều kiện hoạt động, điều kiện giao dịch trên nền tảng TMĐT',kw:['kCQN','kCNĐ','kLBH'],
...
{n:12,name:'Đặt hàng trên nền tảng TMĐT có chức năng đặt hàng trực tuyến',kw:['kCNĐ'],
...
{n:13,name:'Giao kết hợp đồng tự động trên nền tảng TMĐT',kw:['kCQN','kHĐT2'],
...
{n:14,name:'Quản lý và vận hành nền tảng TMĐT',kw:['kNTT2','kNTT3','kMXH','kNTT4','kCQN','kCNĐ'],
...
{n:15,name:'Trách nhiệm của chủ quản nền tảng TMĐT',kw:['kNTT3','kMXH','kCQN','kCNĐ'],
...
{n:16,name:'Trách nhiệm của chủ quản nền tảng TMĐT kinh doanh trực tiếp',kw:['kNTT2','kCQN','kCNĐ'],
...
{n:17,name:'Trách nhiệm của chủ quản nền tảng TMĐT trung gian',kw:['kNTT3','kCQN','kCNĐ'],
...
{n:18,name:'Trách nhiệm của chủ quản mạng xã hội hoạt động TMĐT',kw:['kMXH','kCNĐ','kCNL','kLBH'],
...
{n:19,name:'Trách nhiệm của chủ quản nền tảng TMĐT tích hợp',kw:['kNTT4','kCQN'],
...
{n:20,name:'Trách nhiệm của chủ quản NTTMĐT được tích hợp trên nền tảng TMĐT tích hợp',kw:['kNTT','kNTT4','kCQN'],
...
{n:21,name:'Trách nhiệm của người bán trên nền tảng TMĐT trung gian, mạng xã hội hoạt động TMĐT',kw:['kNTT3','kMXH','kCQN','kCNĐ'],
...
{n:22,name:'Trách nhiệm của chủ quản nền tảng TMĐT trong hoạt động livestream bán hàng',kw:['kLBH','kNLB'],
...
{n:23,name:'Trách nhiệm của người bán trong hoạt động livestream bán hàng',kw:['kLBH','kNLB'],
...
{n:24,name:'Trách nhiệm của người livestream bán hàng',kw:['kCQN','kLBH','kNLB'],
...
{n:25,name:'Trách nhiệm của tổ chức, cá nhân cung cấp dịch vụ tiếp thị liên kết trong TMĐT',kw:[],
...
{n:26,name:'Trách nhiệm của người tiếp thị liên kết trong TMĐT',kw:['kNTT5'],
...
{n:27,name:'Nền tảng TMĐT nước ngoài có hoạt động TMĐT tại Việt Nam',kw:['kNTT2','kNTT3','kMXH','kNTT4','kCQN','kCNĐ'],
...
{n:28,name:'Trách nhiệm của chủ quản nền tảng TMĐT nước ngoài, người bán, người livestream, người tiếp thị liên kết trên nền tảng TMĐT nước ngoài tại Việt Nam',kw:['kCQN','kLBH','kNLB'],
...
{n:29,name:'Trách nhiệm của đại diện ủy quyền tại Việt Nam đối với nền tảng TMĐT trung gian không có chức năng đặt hàng trực tuyến, mạng xã hội hoạt động TMĐT không có chức năng đặt hàng trực tuyến',kw:['kHĐT'],
...
{n:30,name:'Trách nhiệm của pháp nhân ủy quyền tại Việt Nam đối với nền tảng TMĐT kinh doanh trực tiếp, trung gian và mạng xã hội hoạt động TMĐT có chức năng đặt hàng trực tuyến',kw:[],
...
{n:31,name:'Trách nhiệm của pháp nhân ủy quyền tại Việt Nam đối với nền tảng TMĐT tích hợp',kw:[],
...
{n:32,name:'Hoạt động đầu tư nước ngoài vào lĩnh vực TMĐT',kw:['kNTT3','kMXH','kNTT4'],
...
{n:33,name:'Trách nhiệm của tổ chức cung cấp dịch vụ hạ tầng kỹ thuật hỗ trợ TMĐT',kw:[],
...
{n:34,name:'Trách nhiệm của tổ chức cung cấp dịch vụ logistics hỗ trợ TMĐT',kw:['kCQN'],
...
{n:35,name:'Trách nhiệm của tổ chức cung ứng dịch vụ thanh toán, dịch vụ trung gian thanh toán hỗ trợ TMĐT',kw:[],
...
{n:36,name:'Dịch vụ chứng thực hợp đồng điện tử trong thương mại',kw:['kDVC'],
...
{n:37,name:'Hệ thống quản lý hoạt động thương mại điện tử',kw:['kDVC'],
...
{n:38,name:'Cơ sở dữ liệu về thương mại điện tử',kw:['kNTT'],
...
{n:39,name:'Xử lý vi phạm trong thương mại điện tử',kw:['kHĐT','kDVC'],
...
{n:41,name:'Quy định chuyển tiếp',kw:['kHĐT'],
...
KW:[
  {id:'kHĐT',  lbl:'Hoạt động thương\nmại điện tử', type:'kwg',
   terms:['hoạt động thương mại điện tử']},
  {id:'kNTT',  lbl:'Nền tảng thương\nmại điện tử', type:'kwg',
   terms:['nền tảng thương mại điện tử']},
  {id:'kNTT2',  lbl:'Nền tảng TMĐT kinh\ndoanh trực tiếp', type:'kwg',
   terms:['nền tảng tmđt kinh doanh trực tiếp']},
  {id:'kNTT3',  lbl:'Nền tảng TMĐT\ntrung gian', type:'kwg',
   terms:['nền tảng tmđt trung gian']},
  {id:'kMXH',  lbl:'Mạng xã hội\nhoạt động TMĐT', type:'kwg',
   terms:['mạng xã hội hoạt động tmđt']},
  {id:'kNTT4',  lbl:'Nền tảng\nTMĐT tích hợp', type:'kwg',
   terms:['nền tảng tmđt tích hợp']},
  {id:'kCQN',  lbl:'Chủ quản\nnền tảng TMĐT', type:'kwg',
   terms:['chủ quản nền tảng tmđt']},
  {id:'kCNĐ',  lbl:'Chức năng đặt\nhàng trực tuyến', type:'kwg',
   terms:['chức năng đặt hàng trực tuyến']},
  {id:'kCNL',  lbl:'Chức năng liên\nlạc trực tuyến', type:'kwg',
   terms:['chức năng liên lạc trực tuyến']},
  {id:'kLBH',  lbl:'Livestream\nbán hàng', type:'kwc',
   terms:['livestream bán hàng']},
  {id:'kNLB',  lbl:'Người livestream\nbán hàng', type:'kwg',
   terms:['người livestream bán hàng']},
  {id:'kDVT',  lbl:'Dịch vụ tiếp thị\nliên kết trong TMĐT', type:'kwg',
   terms:['dịch vụ tiếp thị liên kết trong tmđt']},
  {id:'kTCC',  lbl:'Tổ chức, cá nhân cung cấp dịch\nvụ tiếp thị liên kết trong TMĐT', type:'kwg',
   terms:['tổ chức, cá nhân cung cấp dịch vụ tiếp thị liên kết trong tmđt']},
  {id:'kNTT5',  lbl:'Người tiếp thị\nliên kết trong TMĐT', type:'kwg',
   terms:['người tiếp thị liên kết trong tmđt']},
  {id:'kDVC',  lbl:'Dịch vụ chứng thực hợp đồng\nđiện tử trong thương mại', type:'kwg',
   terms:['dịch vụ chứng thực hợp đồng điện tử trong thương mại']},
  {id:'kHĐT2',  lbl:'Hợp đồng\ntự động', type:'kwg',
   terms:['hợp đồng tự động']},
],
