// ═══════════════════════════════════════════════════
// DATA MODULE — Luật Bảo vệ dữ liệu cá nhân 91/2025/QH15
// LegalMap · Hướng Dương Edition
// ═══════════════════════════════════════════════════

window.LUAT_REGISTRY = window.LUAT_REGISTRY || {};
window.LUAT_REGISTRY['luat_091_2025'] = {
  ...
  meta: {
    ...
    dieu:    39,
    hieuluc: '01/01/2026',
    color:   '#7B1FA2',  // tím — bảo vệ riêng tư
    colorCh: '#9C27B0',
    colorD:  '#BA68C8',
  },
...
// ── CHƯƠNG ─────────────────────────────────────────────
CH:[
  {id:'c1',lbl:'Ch.I\nQuy định chung',from:1,to:8,
   desc:'Chương I — Những quy định chung\nĐiều 1 đến Điều 8'},
  {id:'c2',lbl:'Ch.II\nBảo vệ dữ liệu\ncá nhân',from:9,to:32,
   desc:'Chương II — Bảo vệ dữ liệu cá nhân (xử lý + một số hoạt động)\nĐiều 9 đến Điều 32'},
  {id:'c3',lbl:'Ch.III\nLực lượng\nđiều kiện',from:33,to:35,
   desc:'Chương III — Lực lượng, điều kiện bảo đảm bảo vệ dữ liệu cá nhân\nĐiều 33 đến Điều 35'},
  {id:'c4',lbl:'Ch.IV\nTrách nhiệm\ncơ quan, tổ chức',from:36,to:37,
   desc:'Chương IV — Trách nhiệm của cơ quan, tổ chức, cá nhân về bảo vệ dữ liệu cá nhân\nĐiều 36 đến Điều 37'},
  {id:'c5',lbl:'Ch.V\nĐiều khoản\nthi hành',from:38,to:39,
   desc:'Chương V — Điều khoản thi hành\nĐiều 38 đến Điều 39'},
],

// ── ĐIỀU LUẬT ───────────────────────────────────────────
DD:[
{n:1,name:'Phạm vi điều chỉnh và đối tượng áp dụng',kw:['kDLCN','kXL'],
full:`1. Luật này quy định về dữ liệu cá nhân, bảo vệ dữ liệu cá nhân và quyền, nghĩa vụ, trách nhiệm của cơ quan, tổ chức, cá nhân có liên quan.
...
{n:2,name:'Giải thích từ ngữ',kw:['kDLCN','kCT','kKS','kXL','kDG','kTC','kCQ'],
...
{n:3,name:'Nguyên tắc bảo vệ dữ liệu cá nhân',kw:['kDLCN','kXL','kVP','kCQ'],
full:`1. Tuân thủ quy định của Hiến pháp, quy định của Luật này và quy định khác của pháp luật có liên quan.
...
{n:4,name:'Quyền và nghĩa vụ của chủ thể dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kCQ'],
full:`1. Quyền của chủ thể dữ liệu cá nhân bao gồm:
...
{n:5,name:'Áp dụng pháp luật về bảo vệ dữ liệu cá nhân',kw:['kDLCN','kXL','kDG','kCBR'],
full:`1. Hoạt động bảo vệ dữ liệu cá nhân trên lãnh thổ nước Cộng hòa xã hội chủ nghĩa Việt Nam thực hiện theo quy định của Luật này và quy định khác của pháp luật có liên quan.
...
{n:6,name:'Hợp tác quốc tế về bảo vệ dữ liệu cá nhân',kw:['kDLCN','kXL','kCBR','kCQ'],
full:`1. Tuân thủ pháp luật Việt Nam, điều ước quốc tế mà nước Cộng hòa xã hội chủ nghĩa Việt Nam là thành viên và thỏa thuận quốc tế về bảo vệ dữ liệu cá nhân trên cơ sở bình đẳng, cùng có lợi, tôn trọng độc lập, chủ quyền và toàn vẹn lãnh thổ.
...
{n:7,name:'Hành vi bị nghiêm cấm',kw:['kDLCN','kXL','kVP','kCQ'],
full:`1. Xử lý dữ liệu cá nhân nhằm chống lại Nhà nước Cộng hòa xã hội chủ nghĩa Việt Nam, gây ảnh hưởng đến quốc phòng, an ninh quốc gia, trật tự, an toàn xã hội, quyền, lợi ích hợp pháp của cơ quan, tổ chức, cá nhân.
...
{n:8,name:'Xử lý vi phạm pháp luật về bảo vệ dữ liệu cá nhân',kw:['kDLCN','kCBR','kVP','kCQ'],
...
{n:9,name:'Sự đồng ý của chủ thể dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kCQ'],
full:`1. Sự đồng ý của chủ thể dữ liệu cá nhân là việc chủ thể dữ liệu cá nhân cho phép xử lý dữ liệu cá nhân của mình, trừ trường hợp pháp luật có quy định khác.
...
{n:10,name:'Yêu cầu rút lại sự đồng ý, yêu cầu hạn chế xử lý dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL'],
...
{n:11,name:'Thu thập, phân tích, tổng hợp dữ liệu cá nhân',kw:['kDLCN','kCT','kXL'],
full:`1. Dữ liệu cá nhân được thu thập phải được sự đồng ý của chủ thể dữ liệu cá nhân trước khi thu thập, trừ trường hợp pháp luật có quy định khác.
...
{n:12,name:'Mã hóa, giải mã dữ liệu cá nhân',kw:['kDLCN','kXL'],
full:`1. Mã hóa dữ liệu cá nhân là việc chuyển đổi dữ liệu cá nhân sang dạng không nhận biết được dữ liệu cá nhân nếu không được giải mã; dữ liệu cá nhân sau khi được mã hóa vẫn là dữ liệu cá nhân.
...
{n:13,name:'Chỉnh sửa dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL'],
...
{n:14,name:'Xóa, hủy, khử nhận dạng dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kCQ'],
full:`1. Việc xóa, hủy dữ liệu cá nhân được thực hiện trong các trường hợp sau đây:
...
{n:15,name:'Cung cấp dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kCQ'],
full:`1. Chủ thể dữ liệu cá nhân cung cấp dữ liệu cá nhân cho cơ quan, tổ chức, cá nhân theo quy định của pháp luật hoặc theo thỏa thuận với cơ quan, tổ chức, cá nhân đó.
...
{n:16,name:'Công khai dữ liệu cá nhân',kw:['kDLCN','kCT','kXL'],
full:`1. Dữ liệu cá nhân chỉ được công khai với mục đích cụ thể. Phạm vi công khai, loại dữ liệu cá nhân được công khai phải phù hợp với mục đích công khai. Việc công khai dữ liệu cá nhân không được xâm phạm đến quyền, lợi ích hợp pháp của chủ thể dữ liệu cá nhân.
...
{n:17,name:'Chuyển giao dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kCQ'],
full:`1. Việc chuyển giao dữ liệu cá nhân được thực hiện trong các trường hợp sau đây:
...
{n:18,name:'Các hoạt động khác trong xử lý dữ liệu cá nhân',kw:['kDLCN','kKS','kXL'],
full:`1. Bên kiểm soát dữ liệu cá nhân, bên kiểm soát và xử lý dữ liệu cá nhân, bên xử lý dữ liệu cá nhân, bên thứ ba lưu trữ dữ liệu cá nhân theo hình thức phù hợp với hoạt động của mình và có biện pháp bảo vệ dữ liệu cá nhân trong quá trình lưu trữ theo quy định của pháp luật.
...
{n:19,name:'Xử lý dữ liệu cá nhân trong trường hợp không cần sự đồng ý của chủ thể dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kDG','kCQ'],
full:`1. Các trường hợp xử lý dữ liệu cá nhân không cần sự đồng ý của chủ thể dữ liệu cá nhân bao gồm:
...
{n:20,name:'Chuyển dữ liệu cá nhân xuyên biên giới',kw:['kDLCN','kCT','kXL','kDG','kCBR','kVP','kMK','kVT','kCQ'],
full:`1. Các trường hợp chuyển dữ liệu cá nhân xuyên biên giới bao gồm:
...
{n:21,name:'Đánh giá tác động xử lý dữ liệu cá nhân',kw:['kDLCN','kKS','kXL','kDG','kCQ'],
...
{n:22,name:'Cập nhật hồ sơ đánh giá tác động xử lý dữ liệu cá nhân và hồ sơ đánh giá tác động chuyển dữ liệu cá nhân xuyên biên giới',kw:['kDLCN','kXL','kDG','kCBR','kMK','kCQ','kDV'],
full:`1. Hồ sơ đánh giá tác động xử lý dữ liệu cá nhân và hồ sơ đánh giá tác động chuyển dữ liệu cá nhân xuyên biên giới được cập nhật định kỳ 06 tháng khi có sự thay đổi hoặc cập nhật ngay trong các trường hợp quy định tại khoản 2 Điều này.
...
{n:23,name:'Thông báo vi phạm quy định về bảo vệ dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kVP','kCQ'],
...
{n:24,name:'Bảo vệ dữ liệu cá nhân của trẻ em, người bị mất hoặc hạn chế năng lực hành vi dân sự, người có khó khăn trong nhận thức, làm chủ hành vi',kw:['kDLCN','kCT','kXL','kTE'],
full:`1. Bảo vệ dữ liệu cá nhân của trẻ em, người bị mất hoặc hạn chế năng lực hành vi dân sự, người có khó khăn trong nhận thức, làm chủ hành vi thực hiện theo quy định của Luật này.
...
{n:25,name:'Bảo vệ dữ liệu cá nhân trong tuyển dụng, quản lý, sử dụng người lao động',kw:['kDLCN','kCT','kXL','kVT'],
full:`1. Trách nhiệm bảo vệ dữ liệu cá nhân của cơ quan, tổ chức, cá nhân trong tuyển dụng lao động được quy định như sau:
...
{n:26,name:'Bảo vệ dữ liệu cá nhân đối với thông tin sức khỏe và trong hoạt động kinh doanh bảo hiểm',kw:['kDLCN','kCT','kKS','kXL','kMK','kDV'],
full:`1. Việc bảo vệ dữ liệu cá nhân đối với các thông tin sức khỏe và trong hoạt động kinh doanh bảo hiểm được quy định như sau:
...
{n:27,name:'Bảo vệ dữ liệu cá nhân trong hoạt động tài chính, ngân hàng, hoạt động thông tin tín dụng',kw:['kDLCN','kCT','kXL','kAT','kTC','kCQ'],
full:`1. Tổ chức, cá nhân hoạt động trong lĩnh vực tài chính, ngân hàng, hoạt động thông tin tín dụng có trách nhiệm sau đây:
...
{n:28,name:'Bảo vệ dữ liệu cá nhân trong kinh doanh dịch vụ quảng cáo',kw:['kDLCN','kCT','kKS','kXL','kMK'],
...
{n:29,name:'Bảo vệ dữ liệu cá nhân đối với các nền tảng mạng xã hội, dịch vụ truyền thông trực tuyến',kw:['kDLCN','kCT','kXL','kCBR','kAT','kVP','kMK','kTC'],
full:`Tổ chức, cá nhân cung cấp dịch vụ mạng xã hội, dịch vụ truyền thông trực tuyến có trách nhiệm sau đây:
...
{n:30,name:'Bảo vệ dữ liệu cá nhân trong xử lý dữ liệu lớn, trí tuệ nhân tạo, chuỗi khối, vũ trụ ảo, điện toán đám mây',kw:['kDLCN','kCT','kXL','kAT','kAI','kMK','kCQ'],
full:`1. Dữ liệu cá nhân trong môi trường dữ liệu lớn, trí tuệ nhân tạo, chuỗi khối, vũ trụ ảo và điện toán đám mây phải được xử lý đúng mục đích và giới hạn trong phạm vi cần thiết, bảo đảm quyền, lợi ích hợp pháp của chủ thể dữ liệu cá nhân.
...
{n:31,name:'Bảo vệ dữ liệu cá nhân đối với dữ liệu vị trí cá nhân, dữ liệu sinh trắc học',kw:['kDLCN','kCT','kXL','kAT','kCQ'],
full:`1. Dữ liệu vị trí cá nhân là dữ liệu được xác định thông qua công nghệ định vị để biết vị trí và giúp xác định con người cụ thể.
...
{n:32,name:'Bảo vệ dữ liệu cá nhân thu được từ hoạt động ghi âm, ghi hình tại nơi công cộng, hoạt động công cộng',kw:['kDLCN','kCT','kXL','kCQ'],
full:`1. Cơ quan, tổ chức, cá nhân được ghi âm, ghi hình và xử lý dữ liệu cá nhân thu được từ hoạt động ghi âm, ghi hình tại nơi công cộng, hoạt động công cộng mà không cần có sự đồng ý của chủ thể dữ liệu cá nhân trong các trường hợp sau đây:
...
{n:33,name:'Lực lượng bảo vệ dữ liệu cá nhân',kw:['kDLCN','kXL','kMK','kCQ','kDV'],
full:`1. Lực lượng bảo vệ dữ liệu cá nhân bao gồm:
...
{n:34,name:'Tiêu chuẩn, quy chuẩn kỹ thuật về bảo vệ dữ liệu cá nhân',kw:['kDLCN'],
full:`1. Tiêu chuẩn về bảo vệ dữ liệu cá nhân gồm tiêu chuẩn đối với hệ thống thông tin, phần cứng, phần mềm, quản lý, vận hành, xử lý, bảo vệ dữ liệu cá nhân được công bố, thừa nhận áp dụng tại Việt Nam.
...
{n:35,name:'Kiểm tra hoạt động bảo vệ dữ liệu cá nhân',kw:['kDLCN','kCQ'],
full:`Việc kiểm tra hoạt động bảo vệ dữ liệu cá nhân được thực hiện theo quy định của Luật này và theo quy định của Chính phủ.`},

{n:36,name:'Trách nhiệm quản lý nhà nước về bảo vệ dữ liệu cá nhân',kw:['kDLCN','kCQ'],
full:`1. Chính phủ thống nhất thực hiện quản lý nhà nước về bảo vệ dữ liệu cá nhân.
...
{n:37,name:'Trách nhiệm của bên kiểm soát dữ liệu cá nhân, bên xử lý dữ liệu cá nhân, bên kiểm soát và xử lý dữ liệu cá nhân',kw:['kDLCN','kCT','kKS','kXL','kVP','kMK','kCQ'],
full:`1. Trách nhiệm của bên kiểm soát dữ liệu cá nhân như sau:
...
{n:38,name:'Hiệu lực thi hành',kw:['kDLCN','kCT','kXL','kMK','kCQ'],
full:`1. Luật này có hiệu lực thi hành từ ngày 01 tháng 01 năm 2026.
...
{n:39,name:'Quy định chuyển tiếp',kw:['kDLCN','kCT','kXL','kDG','kCBR','kCQ'],
...
// ── TỪ KHOÁ ──────────────────────────────────────────
KW:[
  {id:'kDLCN',  lbl:'Dữ liệu\ncá nhân', type:'kwc',
   terms:['dữ liệu cá nhân','dữ liệu cá nhân cơ bản','dữ liệu cá nhân nhạy cảm','dữ liệu cá nhân của trẻ em','khử nhận dạng']},
  {id:'kCT',  lbl:'Chủ thể\ndữ liệu', type:'kwc',
   terms:['chủ thể dữ liệu cá nhân','quyền của chủ thể','rút lại sự đồng ý','quyền tự bảo vệ']},
  {id:'kKS',  lbl:'Bên kiểm soát\nxử lý', type:'kwc',
   terms:['bên kiểm soát dữ liệu cá nhân','bên xử lý dữ liệu cá nhân','bên kiểm soát và xử lý','bên thứ ba']},
  {id:'kXL',  lbl:'Xử lý\ndữ liệu', type:'kwg',
   terms:['xử lý dữ liệu cá nhân','thu thập','phân tích','tổng hợp','mã hóa','giải mã','chỉnh sửa','xóa','hủy','cung cấp','công khai','chuyển giao']},
  {id:'kDG',  lbl:'Đánh giá\ntác động', type:'kwc',
   terms:['đánh giá tác động xử lý','đánh giá rủi ro','phân tích đánh giá','hồ sơ đánh giá']},
  {id:'kCBR',  lbl:'Chuyển dữ liệu\nra nước ngoài', type:'kwg',
   terms:['chuyển dữ liệu cá nhân ra nước ngoài','xuyên biên giới','quốc gia khác','tổ chức nước ngoài']},
  {id:'kAT',  lbl:'Bảo mật\nan toàn', type:'kwc',
   terms:['bảo mật','an toàn dữ liệu','biện pháp kỹ thuật','phòng chống xâm phạm']},
  {id:'kVP',  lbl:'Vi phạm\n& xử phạt', type:'kwc',
   terms:['hành vi vi phạm','xử lý vi phạm','xử phạt vi phạm hành chính','khiếu nại tố cáo']},
  {id:'kTE',  lbl:'Trẻ em\n& người yếu thế', type:'kwc',
   terms:['dữ liệu cá nhân của trẻ em','người mất năng lực hành vi','người có khó khăn','người bị tuyên bố mất tích']},
  {id:'kAI',  lbl:'AI · Big Data\nTự động hoá', type:'kwg',
   terms:['trí tuệ nhân tạo','big data','dữ liệu lớn','học máy','phân tích tự động','quyết định tự động']},
  {id:'kMK',  lbl:'Marketing\nQuảng cáo', type:'kwg',
   terms:['tiếp thị','quảng cáo','marketing','giới thiệu sản phẩm','dịch vụ']},
  {id:'kSK',  lbl:'Sức khỏe\ny tế', type:'kwc',
   terms:['dữ liệu y tế','tình trạng sức khỏe','khám chữa bệnh','bảo hiểm y tế']},
  {id:'kTC',  lbl:'Tài chính\nNgân hàng', type:'kwg',
   terms:['dữ liệu tài chính','ngân hàng','tín dụng','tài khoản','giao dịch']},
  {id:'kVT',  lbl:'Việc làm\nLao động', type:'kwc',
   terms:['hồ sơ lao động','đánh giá nhân sự','tuyển dụng','người lao động']},
  {id:'kCQ',  lbl:'Cơ quan\nNhà nước', type:'kwg',
   terms:['cơ quan nhà nước','Chính phủ','Bộ Công an','Bộ Quốc phòng','an ninh quốc gia','quốc phòng']},
  {id:'kDV',  lbl:'Dịch vụ\nbảo vệ DLCN', type:'kwg',
   terms:['cung cấp dịch vụ bảo vệ dữ liệu','tổ chức cung cấp dịch vụ','tư vấn']},
],
