...
CH:[
  {id:'c1',lbl:'Ch.I\nNhững Quy Định Chung',from:1,to:8,
   desc:'Chương I — NHỮNG QUY ĐỊNH CHUNG\nĐiều 1 đến Điều 8'},
  {id:'c2',lbl:'Ch.II\nBảo Vệ Dữ...',from:9,to:32,
   desc:'Chương II — BẢO VỆ DỮ LIỆU CÁ NHÂN\nĐiều 9 đến Điều 32'},
  {id:'c3',lbl:'Ch.III\nLực Lượng, Điều...',from:33,to:35,
   desc:'Chương III — LỰC LƯỢNG, ĐIỀU KIỆN BẢO ĐẢM BẢO VỆ DỮ LIỆU CÁ NHÂN\nĐiều 33 đến Điều 35'},
  {id:'c4',lbl:'Ch.IV\nTrách Nhiệm Của...',from:36,to:37,
   desc:'Chương IV — TRÁCH NHIỆM CỦA CƠ QUAN, TỔ CHỨC, CÁ NHÂN VỀ BẢO VỆ DỮ LIỆU CÁ NHÂN\nĐiều 36 đến Điều 37'},
  {id:'c5',lbl:'Ch.V\nĐiều Khoản Thi Hành',from:38,to:39,
   desc:'Chương V — ĐIỀU KHOẢN THI HÀNH\nĐiều 38 đến Điều 39'},
],

DD:[
{n:1,name:'Phạm vi điều chỉnh và đối tượng áp dụng',kw:['kDLC','kBVD','kXLD'],
...
{n:2,name:'Giải thích từ ngữ',kw:['kDLC','kDLC2','kDLC3','kBVD','kCTD','kXLD','kBKS','kBXL','kBKS2','kBTB','kKND','kĐGT'],
...
{n:3,name:'Nguyên tắc bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD','kXLD'],
...
{n:4,name:'Quyền và nghĩa vụ của chủ thể dữ liệu cá nhân',kw:['kDLC','kBVD','kCTD','kXLD','kBKS','kBXL','kBKS2'],
...
{n:5,name:'Áp dụng pháp luật về bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD','kXLD','kĐGT'],
...
{n:6,name:'Hợp tác quốc tế về bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD'],
...
{n:7,name:'Hành vi bị nghiêm cấm',kw:['kDLC','kBVD','kXLD'],
...
{n:8,name:'Xử lý vi phạm pháp luật về bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD'],
...
{n:9,name:'Sự đồng ý của chủ thể dữ liệu cá nhân',kw:['kDLC','kCTD','kXLD','kBKS','kBKS2'],
...
{n:10,name:'Yêu cầu rút lại sự đồng ý, yêu cầu hạn chế xử lý dữ liệu cá nhân',kw:['kDLC','kCTD','kXLD','kBKS','kBXL','kBKS2'],
...
{n:11,name:'Thu thập, phân tích, tổng hợp dữ liệu cá nhân',kw:['kDLC','kCTD'],
...
{n:12,name:'Mã hóa, giải mã dữ liệu cá nhân',kw:['kDLC','kXLD'],
...
{n:13,name:'Chỉnh sửa dữ liệu cá nhân',kw:['kDLC','kCTD','kXLD','kBKS','kBXL','kBKS2','kBTB'],
...
{n:14,name:'Xóa, hủy, khử nhận dạng dữ liệu cá nhân',kw:['kDLC','kCTD','kXLD','kBKS','kBXL','kBKS2','kBTB','kKND'],
...
{n:15,name:'Cung cấp dữ liệu cá nhân',kw:['kDLC','kCTD','kXLD','kBKS','kBKS2'],
...
{n:16,name:'Công khai dữ liệu cá nhân',kw:['kDLC','kCTD'],
...
{n:17,name:'Chuyển giao dữ liệu cá nhân',kw:['kDLC','kCTD','kXLD','kBKS','kBXL','kBKS2','kBTB'],
...
{n:18,name:'Các hoạt động khác trong xử lý dữ liệu cá nhân',kw:['kDLC','kBVD','kXLD','kBKS','kBXL','kBKS2','kBTB'],
...
{n:19,name:'Xử lý dữ liệu cá nhân trong trường hợp không cần sự đồng ý của chủ thể dữ liệu cá nhân',kw:['kDLC','kBVD','kCTD','kXLD','kBKS','kBXL','kBKS2','kBTB'],
...
{n:20,name:'Chuyển dữ liệu cá nhân xuyên biên giới',kw:['kDLC','kBVD','kCTD','kXLD'],
...
{n:21,name:'Đánh giá tác động xử lý dữ liệu cá nhân',kw:['kDLC','kBVD','kXLD','kBKS','kBXL','kBKS2','kĐGT'],
...
{n:22,name:'Cập nhật hồ sơ đánh giá tác động xử lý dữ liệu cá nhân và hồ sơ đánh giá tác động chuyển dữ liệu cá nhân xuyên biên giới',kw:['kDLC','kBVD','kXLD','kĐGT'],
...
{n:23,name:'Thông báo vi phạm quy định về bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD','kCTD','kXLD','kBKS','kBXL','kBKS2','kBTB'],
...
{n:24,name:'Bảo vệ dữ liệu cá nhân của trẻ em, người bị mất hoặc hạn chế năng lực hành vi dân sự, người có khó khăn trong nhận thức, làm chủ hành vi',kw:['kDLC','kBVD','kCTD','kXLD'],
...
{n:25,name:'Bảo vệ dữ liệu cá nhân trong tuyển dụng, quản lý, sử dụng người lao động',kw:['kDLC','kBVD','kCTD','kXLD'],
...
{n:26,name:'Bảo vệ dữ liệu cá nhân đối với thông tin sức khỏe và trong hoạt động kinh doanh bảo hiểm',kw:['kDLC','kBVD','kCTD','kXLD','kBTB'],
...
{n:27,name:'Bảo vệ dữ liệu cá nhân trong hoạt động tài chính, ngân hàng, hoạt động thông tin tín dụng',kw:['kDLC','kDLC3','kBVD','kCTD','kXLD'],
...
{n:28,name:'Bảo vệ dữ liệu cá nhân trong kinh doanh dịch vụ quảng cáo',kw:['kDLC','kCTD','kXLD','kBKS','kBKS2'],
...
{n:29,name:'Bảo vệ dữ liệu cá nhân đối với các nền tảng mạng xã hội, dịch vụ truyền thông trực tuyến',kw:['kDLC','kBVD','kCTD'],
...
{n:30,name:'Bảo vệ dữ liệu cá nhân trong xử lý dữ liệu lớn, trí tuệ nhân tạo, chuỗi khối, vũ trụ ảo, điện toán đám mây',kw:['kDLC','kBVD','kCTD','kXLD'],
...
{n:31,name:'Bảo vệ dữ liệu cá nhân đối với dữ liệu vị trí cá nhân, dữ liệu sinh trắc học',kw:['kDLC','kBVD','kCTD'],
...
{n:32,name:'Bảo vệ dữ liệu cá nhân thu được từ hoạt động ghi âm, ghi hình tại nơi công cộng, hoạt động công cộng',kw:['kDLC','kBVD','kCTD','kXLD'],
...
{n:33,name:'Lực lượng bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD','kXLD'],
...
{n:34,name:'Tiêu chuẩn, quy chuẩn kỹ thuật về bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD'],
...
{n:35,name:'Kiểm tra hoạt động bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD'],
...
{n:36,name:'Trách nhiệm quản lý nhà nước về bảo vệ dữ liệu cá nhân',kw:['kDLC','kBVD'],
...
{n:37,name:'Trách nhiệm của bên kiểm soát dữ liệu cá nhân, bên xử lý dữ liệu cá nhân, bên kiểm soát và xử lý dữ liệu cá nhân',kw:['kDLC','kBVD','kCTD','kXLD','kBKS','kBXL','kBKS2'],
...
{n:38,name:'Hiệu lực thi hành',kw:['kDLC','kDLC3','kCTD','kXLD'],
...
{n:39,name:'Quy định chuyển tiếp',kw:['kDLC','kBVD','kCTD','kXLD','kĐGT'],
...
KW:[
  {id:'kDLC',  lbl:'Dữ liệu\ncá nhân', type:'kwg',
   terms:['dữ liệu cá nhân']},
  {id:'kDLC2',  lbl:'Dữ liệu cá\nnhân cơ bản', type:'kwg',
   terms:['dữ liệu cá nhân cơ bản']},
  {id:'kDLC3',  lbl:'Dữ liệu cá\nnhân nhạy cảm', type:'kwg',
   terms:['dữ liệu cá nhân nhạy cảm']},
  {id:'kBVD',  lbl:'Bảo vệ dữ\nliệu cá nhân', type:'kwg',
   terms:['bảo vệ dữ liệu cá nhân']},
  {id:'kCTD',  lbl:'Chủ thể dữ\nliệu cá nhân', type:'kwg',
   terms:['chủ thể dữ liệu cá nhân']},
  {id:'kXLD',  lbl:'Xử lý dữ\nliệu cá nhân', type:'kwg',
   terms:['xử lý dữ liệu cá nhân']},
  {id:'kBKS',  lbl:'Bên kiểm soát\ndữ liệu cá nhân', type:'kwg',
   terms:['bên kiểm soát dữ liệu cá nhân']},
  {id:'kBXL',  lbl:'Bên xử lý\ndữ liệu cá nhân', type:'kwg',
   terms:['bên xử lý dữ liệu cá nhân']},
  {id:'kBKS2',  lbl:'Bên kiểm soát và\nxử lý dữ liệu cá nhân', type:'kwg',
   terms:['bên kiểm soát và xử lý dữ liệu cá nhân']},
  {id:'kBTB',  lbl:'Bên thứ ba', type:'kwc',
   terms:['bên thứ ba']},
  {id:'kKND',  lbl:'Khử nhận dạng\ndữ liệu cá nhân', type:'kwg',
   terms:['khử nhận dạng dữ liệu cá nhân']},
  {id:'kĐGT',  lbl:'Đánh giá tác động\nxử lý dữ liệu cá nhân', type:'kwg',
   terms:['đánh giá tác động xử lý dữ liệu cá nhân']},
],
