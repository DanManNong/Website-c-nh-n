// ═══════════════════════════════════════════════════
// DATA MODULE — Luật Bảo vệ quyền lợi người tiêu dùng 19/2023/QH15
// LegalMap · Hướng Dương Edition
// Auto-generated by add_law.py
// ═══════════════════════════════════════════════════

window.LUAT_REGISTRY = window.LUAT_REGISTRY || {};
window.LUAT_REGISTRY['luat_019_2023'] = {
...
CH:[
  {id:'c1',lbl:'Ch.I\nNhững Quy Định Chung',from:1,to:13,
   desc:'Chương I — NHỮNG QUY ĐỊNH CHUNG\nĐiều 1 đến Điều 13'},
  {id:'c2',lbl:'Ch.II\nTrách Nhiệm Của...',from:14,to:36,
   desc:'Chương II — TRÁCH NHIỆM CỦA TỔ CHỨC, CÁ NHÂN KINH DOANH ĐỐI VỚI NGƯỜI TIÊU DÙNG\nĐiều 14 đến Điều 36'},
  {id:'c3',lbl:'Ch.III\nTrách Nhiệm Của...',from:37,to:47,
   desc:'Chương III — TRÁCH NHIỆM CỦA TỔ CHỨC, CÁ NHÂN KINH DOANH ĐỐI VỚI NGƯỜI TIÊU DÙNG TRONG GIAO DỊCH ĐẶC THÙ\nĐiều 37 đến Điều 47'},
  {id:'c4',lbl:'Ch.IV\nHoạt Động Bảo...',from:48,to:53,
   desc:'Chương IV — HOẠT ĐỘNG BẢO VỆ QUYỀN LỢI NGƯỜI TIÊU DÙNG CỦA MẶT TRẬN TỔ QUỐC VIỆT NAM, TỔ CHỨC CHÍNH TRỊ - XÃ HỘI VÀ TỔ CHỨC XÃ HỘI\nĐiều 48 đến Điều 53'},
  {id:'c5',lbl:'Ch.V\nGiải Quyết Tranh...',from:54,to:73,
   desc:'Chương V — GIẢI QUYẾT TRANH CHẤP GIỮA NGƯỜI TIÊU DÙNG VÀ TỔ CHỨC, CÁ NHÂN KINH DOANH\nĐiều 54 đến Điều 73'},
  {id:'c6',lbl:'Ch.VI\nQuản Lý Nhà...',from:74,to:77,
   desc:'Chương VI — QUẢN LÝ NHÀ NƯỚC VỀ BẢO VỆ QUYỀN LỢI NGƯỜI TIÊU DÙNG\nĐiều 74 đến Điều 77'},
  {id:'c7',lbl:'Ch.VII\nĐiều Khoản Thi Hành',from:78,to:80,
   desc:'Chương VII — ĐIỀU KHOẢN THI HÀNH\nĐiều 78 đến Điều 80'},
],

DD:[
{n:1,name:'Phạm vi điều chỉnh',kw:['kNTD','kTCC'],
...
{n:2,name:'Đối tượng áp dụng',kw:['kNTD','kTCC'],
full:`1. Người tiêu dùng.
...
{n:3,name:'Giải thích từ ngữ',kw:['kNTD','kTCC','kSPH','kGDT','kCCD','kBHT','kNCẢ','kTDB'],
...
{n:4,name:'Quyền của người tiêu dùng',kw:['kNTD','kTCC','kSPH'],
full:`1. Được bảo đảm an toàn tính mạng, sức khoẻ, danh dự, nhân phẩm, uy tín, tài sản, bảo vệ thông tin, quyền, lợi ích hợp pháp khác khi tham gia giao dịch, sử dụng sản phẩm, hàng hóa, dịch vụ do tổ chức, cá nhân kinh doanh cung cấp.
...
{n:5,name:'Nghĩa vụ của người tiêu dùng',kw:['kNTD','kTCC','kTDB'],
full:`1. Kiểm tra sản phẩm, hàng hóa trước khi nhận theo quy định của pháp luật; lựa chọn tiêu dùng sản phẩm, hàng hóa có nguồn gốc, xuất xứ rõ ràng.
...
{n:6,name:'Nguyên tắc bảo vệ quyền lợi người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Bảo vệ quyền lợi người tiêu dùng là trách nhiệm của Nhà nước, tổ chức, cá nhân và toàn xã hội.
...
{n:7,name:'Chính sách của Nhà nước về bảo vệ quyền lợi người tiêu dùng',kw:['kNTD','kTCC','kTDB'],
full:`1. Tạo điều kiện thuận lợi để người tiêu dùng, cơ quan, tổ chức, cá nhân khác thực hiện đầy đủ quyền, nghĩa vụ và phát huy sự chủ động trong hoạt động bảo vệ quyền lợi người tiêu dùng; khuyến khích, tôn vinh người tiêu dùng, tổ chức, cá nhân khác tham gia bảo vệ quyền lợi người tiêu dùng.
...
{n:8,name:'Bảo vệ quyền lợi người tiêu dùng dễ bị tổn thương',kw:['kNTD','kTCC'],
full:`1. Người tiêu dùng dễ bị tổn thương là người tiêu dùng có khả năng chịu nhiều tác động bất lợi về tiếp cận thông tin, sức khỏe, tài sản, giải quyết tranh chấp tại thời điểm mua hoặc sử dụng sản phẩm, hàng hóa, dịch vụ, bao gồm:
...
{n:9,name:'Bảo vệ quyền lợi người tiêu dùng trong giao dịch với cá nhân hoạt động thương mại độc lập, thường xuyên, không phải đăng ký kinh doanh',kw:['kNTD'],
full:`1. Cá nhân hoạt động thương mại độc lập, thường xuyên, không phải đăng ký kinh doanh theo quy định của Luật này chỉ phải thực hiện các trách nhiệm sau đây:
...
{n:10,name:'Các hành vi bị nghiêm cấm trong bảo vệ quyền lợi người tiêu dùng',kw:['kNTD','kTCC','kNCẢ'],
full:`1. Tổ chức, cá nhân kinh doanh bị nghiêm cấm thực hiện các hành vi sau đây:
...
{n:11,name:'Yêu cầu cơ quan nhà nước xử lý vi phạm pháp luật có liên quan đến quyền lợi người tiêu dùng',kw:['kNTD','kTCC'],
...
{n:12,name:'Hợp tác quốc tế trong bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
...
{n:13,name:'Ngày Quyền của người tiêu dùng Việt Nam',kw:['kNTD'],
full:`1. Ngày 15 tháng 3 hằng năm là Ngày Quyền của người tiêu dùng Việt Nam.
2. Chính phủ quy định việc tổ chức thực hiện các hoạt động hưởng ứng Ngày Quyền của người tiêu dùng Việt Nam.`},

{n:14,name:'Bảo đảm an toàn, đo lường, số lượng, khối lượng, chất lượng, công dụng sản phẩm, hàng hóa, dịch vụ bán, cung cấp cho người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh phải bảo đảm an toàn, đo lường, số lượng, khối lượng, chất lượng, công dụng sản phẩm, hàng hóa, dịch vụ bán, cung cấp cho người tiêu dùng theo đúng nội dung đã đăng ký, thông báo, công bố, niêm yết, quảng cáo, giới thiệu, giao kết, cam kết hoặc theo quy định của pháp luật.
...
{n:15,name:'Bảo vệ thông tin của người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh tự mình hoặc ủy quyền, thuê bên thứ ba thực hiện việc thu thập, lưu trữ, sử dụng, chỉnh sửa, cập nhật, hủy bỏ thông tin của người tiêu dùng phải bảo đảm an toàn, an ninh thông tin của người tiêu dùng theo quy định của Luật này và quy định khác của pháp luật có liên quan.
...
{n:16,name:'Xây dựng quy tắc bảo vệ thông tin của người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Trừ trường hợp pháp luật có quy định khác, tổ chức, cá nhân kinh doanh thu thập, lưu trữ, sử dụng thông tin của người tiêu dùng phải xây dựng quy tắc bảo vệ thông tin áp dụng chung cho người tiêu dùng với các nội dung sau đây:
...
{n:17,name:'Thông báo khi thu thập, sử dụng thông tin của người tiêu dùng',kw:['kNTD','kTCC'],
...
{n:18,name:'Sử dụng thông tin của người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Trước khi tổ chức, cá nhân kinh doanh thay đổi mục đích, phạm vi sử dụng thông tin đã thông báo cho người tiêu dùng thì phải thông báo lại và được người tiêu dùng đồng ý về việc thay đổi.
...
{n:19,name:'Bảo đảm an toàn, an ninh thông tin của người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh phải bảo đảm an toàn, an ninh thông tin của người tiêu dùng mà họ thu thập, lưu trữ, sử dụng và có biện pháp ngăn ngừa các hành vi sau đây:
...
{n:20,name:'Kiểm tra, chỉnh sửa, cập nhật, hủy bỏ, chuyển giao, ngừng chuyển giao thông tin của người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Người tiêu dùng có quyền yêu cầu tổ chức, cá nhân kinh doanh thực hiện việc kiểm tra, chỉnh sửa, cập nhật, hủy bỏ, chuyển giao hoặc ngừng chuyển giao thông tin của mình cho bên thứ ba.
...
{n:21,name:'Cung cấp thông tin về sản phẩm, hàng hóa, dịch vụ, hợp đồng theo mẫu, điều kiện giao dịch chung cho người tiêu dùng',kw:['kNTD','kTCC'],
full:`Tổ chức, cá nhân kinh doanh có trách nhiệm sau đây:
...
{n:22,name:'Trách nhiệm của bên thứ ba trong việc cung cấp thông tin về sản phẩm, hàng hóa, dịch vụ cho người tiêu dùng',kw:['kNTD','kTCC','kNCẢ'],
full:`1. Trường hợp tổ chức, cá nhân kinh doanh cung cấp thông tin về sản phẩm, hàng hóa, dịch vụ cho người tiêu dùng thông qua bên thứ ba thì bên thứ ba có trách nhiệm sau đây:
...
{n:23,name:'Hợp đồng giao kết với người tiêu dùng, hợp đồng theo mẫu, điều kiện giao dịch chung',kw:['kNTD'],
full:`1. Hình thức hợp đồng giao kết với người tiêu dùng, hợp đồng theo mẫu, điều kiện giao dịch chung được thực hiện theo quy định của pháp luật về dân sự và quy định khác của pháp luật có liên quan.
...
{n:24,name:'Giải thích hợp đồng giao kết với người tiêu dùng, hợp đồng theo mẫu, điều kiện giao dịch chung',kw:['kNTD'],
full:`Trong trường hợp hiểu khác nhau về nội dung hợp đồng giao kết với người tiêu dùng, hợp đồng theo mẫu, điều kiện giao dịch chung thì việc giải thích được thực hiện theo hướng có lợi cho người tiêu dùng.`},

{n:25,name:'Điều khoản không được phép quy định trong hợp đồng giao kết với người tiêu dùng, hợp đồng theo mẫu, điều kiện giao dịch chung',kw:['kNTD','kTCC','kCCD'],
full:`Trong hợp đồng giao kết với người tiêu dùng, hợp đồng theo mẫu, điều kiện giao dịch chung, tổ chức, cá nhân kinh doanh không được quy định các điều khoản sau đây:
...
{n:26,name:'Thực hiện hợp đồng theo mẫu',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh phải dành thời gian hợp lý để người tiêu dùng nghiên cứu hợp đồng trước khi giao kết hợp đồng theo mẫu.
...
{n:27,name:'Thực hiện điều kiện giao dịch chung',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh sử dụng điều kiện giao dịch chung có trách nhiệm công khai và phải dành thời gian hợp lý để người tiêu dùng nghiên cứu điều kiện giao dịch chung trước khi giao dịch.
...
{n:28,name:'Kiểm soát hợp đồng theo mẫu, điều kiện giao dịch chung',kw:['kNTD','kTCC'],
...
{n:29,name:'Cung cấp bằng chứng giao dịch',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh có trách nhiệm cung cấp cho người tiêu dùng hóa đơn, chứng từ, tài liệu liên quan đến giao dịch theo quy định của pháp luật hoặc theo yêu cầu của người tiêu dùng.
...
{n:30,name:'Bảo hành sản phẩm, hàng hóa, linh kiện, phụ kiện',kw:['kNTD','kTCC'],
full:`1. Sản phẩm, hàng hóa, linh kiện, phụ kiện được bảo hành theo thỏa thuận của các bên hoặc bắt buộc bảo hành theo quy định của pháp luật.
...
{n:31,name:'Trách nhiệm tiếp nhận và giải quyết phản ánh, yêu cầu, khiếu nại của người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh có trách nhiệm tổ chức tiếp nhận và giải quyết phản ánh, yêu cầu, khiếu nại của người tiêu dùng.
...
{n:32,name:'Trách nhiệm đối với sản phẩm, hàng hóa có khuyết tật',kw:['kNTD','kTCC','kSPH'],
full:`1. Khi phát hiện sản phẩm, hàng hóa có khuyết tật, tổ chức, cá nhân kinh doanh có trách nhiệm sau đây:
...
{n:33,name:'Thu hồi sản phẩm, hàng hóa có khuyết tật',kw:['kNTD','kTCC','kSPH'],
full:`1. Sản phẩm, hàng hóa có khuyết tật bao gồm:
...
{n:34,name:'Bồi thường thiệt hại do sản phẩm, hàng hóa có khuyết tật gây ra',kw:['kNTD','kTCC','kSPH'],
...
{n:35,name:'Miễn trách nhiệm bồi thường thiệt hại do sản phẩm, hàng hóa có khuyết tật gây ra',kw:['kNTD','kTCC','kSPH'],
full:`Tổ chức, cá nhân kinh doanh quy định tại Điều 34 của Luật này được miễn trách nhiệm bồi thường thiệt hại trong các trường hợp sau đây:
...
{n:36,name:'Trách nhiệm trong việc cung cấp dịch vụ không đúng nội dung đã đăng ký, thông báo, công bố, niêm yết, quảng cáo, giới thiệu, giao kết, cam kết',kw:['kNTD','kTCC'],
...
{n:37,name:'Trách nhiệm của tổ chức, cá nhân kinh doanh trong giao dịch từ xa',kw:['kNTD','kTCC','kGDT'],
full:`1. Khi thực hiện giao dịch từ xa, tổ chức, cá nhân kinh doanh phải cung cấp chính xác và đầy đủ cho người tiêu dùng các thông tin sau đây:
...
{n:38,name:'Giao kết hợp đồng trong giao dịch từ xa',kw:['kNTD','kTCC','kGDT'],
full:`1. Khi giao dịch từ xa với người tiêu dùng, tổ chức, cá nhân kinh doanh có trách nhiệm xây dựng công cụ và thực hiện biện pháp bảo đảm sau đây:
...
{n:39,name:'Trách nhiệm của tổ chức, cá nhân kinh doanh với người tiêu dùng trong giao dịch trên không gian mạng',kw:['kNTD','kTCC','kCCD'],
full:`1. Tổ chức, cá nhân kinh doanh trên không gian mạng bao gồm:
...
{n:40,name:'Trách nhiệm công khai, gỡ bỏ thông tin cảnh báo người tiêu dùng trong giao dịch trên không gian mạng',kw:['kNTD','kTCC','kCCD'],
full:`1. Nội dung công khai thông tin cảnh báo bao gồm:
...
{n:41,name:'Trách nhiệm của tổ chức, cá nhân kinh doanh cung cấp dịch vụ liên tục',kw:['kNTD','kTCC','kGDT','kCCD'],
...
{n:42,name:'Hợp đồng cung cấp dịch vụ liên tục',kw:['kNTD','kTCC','kCCD','kBHT'],
full:`1. Hợp đồng cung cấp dịch vụ liên tục phải được lập thành văn bản và cung cấp cho người tiêu dùng 01 bản.
...
{n:43,name:'Trách nhiệm của tổ chức, cá nhân kinh doanh trong hoạt động bán hàng tận cửa',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh thực hiện hoạt động bán hàng tận cửa thông qua các hình thức sau đây:
a) Tự mình thực hiện;
...
{n:44,name:'Hợp đồng bán hàng tận cửa',kw:['kNTD','kTCC'],
full:`1. Hợp đồng bán hàng tận cửa phải được lập thành văn bản và cung cấp cho người tiêu dùng 01 bản, trừ trường hợp các bên có thỏa thuận khác.
...
{n:45,name:'Trách nhiệm của tổ chức, cá nhân bán hàng đa cấp',kw:['kNTD'],
full:`1. Tổ chức bán hàng đa cấp có trách nhiệm sau đây:
...
{n:46,name:'Hợp đồng tham gia bán hàng đa cấp',kw:[],
full:`1. Tổ chức bán hàng đa cấp và cá nhân tham gia bán hàng đa cấp phải giao kết hợp đồng tham gia bán hàng đa cấp bằng văn bản.
...
{n:47,name:'Trách nhiệm của tổ chức, cá nhân kinh doanh trong hoạt động bán hàng không tại địa điểm giao dịch thường xuyên',kw:['kNTD','kTCC'],
full:`1. Trừ trường hợp pháp luật có quy định khác, khi bán sản phẩm, hàng hóa, cung cấp dịch vụ không tại địa điểm giao dịch thường xuyên với tổng giá trị hơn 10 triệu đồng, tổ chức, cá nhân kinh doanh có trách nhiệm sau đây:
...
{n:48,name:'Trách nhiệm của Mặt trận Tổ quốc Việt Nam và tổ chức chính trị - xã hội',kw:['kNTD','kTCC'],
full:`1. Mặt trận Tổ quốc Việt Nam có trách nhiệm sau đây:
...
{n:49,name:'Tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
full:`1. Tổ chức xã hội thành lập và hoạt động theo quy định của pháp luật về hội được tham gia hoạt động bảo vệ quyền lợi người tiêu dùng.
...
{n:50,name:'Hoạt động của tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng',kw:['kNTD','kTCC'],
full:`1. Hoạt động của tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng bao gồm:
...
{n:51,name:'Quyền của tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
full:`1. Tham gia các hoạt động kiểm tra liên quan đến bảo vệ quyền lợi người tiêu dùng theo yêu cầu của cơ quan nhà nước có thẩm quyền.
...
{n:52,name:'Trách nhiệm của tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
full:`1. Tuân thủ quy định của Luật này và quy định khác của pháp luật có liên quan.
...
{n:53,name:'Tổ chức xã hội có tôn chỉ, mục đích tham gia bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
full:`1. Tổ chức xã hội có tôn chỉ, mục đích tham gia bảo vệ quyền lợi người tiêu dùng thực hiện các hoạt động quy định tại khoản 1 Điều 50 của Luật này.
...
{n:54,name:'Phương thức giải quyết tranh chấp giữa người tiêu dùng và tổ chức, cá nhân kinh doanh',kw:['kNTD','kTCC'],
full:`1. Tranh chấp phát sinh giữa người tiêu dùng và tổ chức, cá nhân kinh doanh được giải quyết thông qua các phương thức sau đây:
a) Thương lượng;
b) Hòa giải;
c) Trọng tài;
d) Tòa án.
...
{n:55,name:'Trách nhiệm cung cấp thông tin, tài liệu trong quá trình giải quyết tranh chấp giữa người tiêu dùng và tổ chức, cá nhân kinh doanh',kw:['kNTD','kTCC'],
...
{n:56,name:'Yêu cầu và tiếp nhận thương lượng',kw:['kNTD','kTCC'],
full:`1. Người tiêu dùng có quyền yêu cầu tổ chức, cá nhân kinh doanh thương lượng.
...
{n:57,name:'Trình tự, thủ tục thương lượng',kw:['kNTD','kTCC'],
...
{n:58,name:'Trường hợp không tiếp nhận và giải quyết yêu cầu hỗ trợ thương lượng',kw:['kNTD'],
full:`1. Người tiêu dùng là người chưa thành niên, người mất năng lực hành vi dân sự hoặc hạn chế năng lực hành vi dân sự hoặc có khó khăn trong nhận thức, làm chủ hành vi mà không có người đại diện hợp pháp.
...
{n:59,name:'Quyền và trách nhiệm của các bên trong quá trình thương lượng',kw:['kNTD','kTCC'],
full:`1. Trong quá trình thương lượng, người tiêu dùng và tổ chức, cá nhân kinh doanh có quyền sau đây:
...
{n:60,name:'Kết quả thương lượng',kw:['kNTD','kTCC'],
full:`1. Kết quả thương lượng của tổ chức, cá nhân kinh doanh với người tiêu dùng được lập thành văn bản, trừ trường hợp các bên có thỏa thuận khác.
...
{n:61,name:'Trình tự, thủ tục hòa giải',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh và người tiêu dùng có quyền thỏa thuận lựa chọn bên thứ ba để thực hiện việc hòa giải.
2. Trình tự, thủ tục hòa giải thực hiện theo quy định của pháp luật về hòa giải.`},

{n:62,name:'Nguyên tắc thực hiện hòa giải',kw:[],
full:`1. Bảo đảm khách quan, trung thực, thiện chí, bình đẳng, công bằng, tự nguyện; không được ép buộc, lừa dối.
...
{n:63,name:'Tổ chức hòa giải',kw:['kNTD','kTCC'],
full:`1. Tổ chức hòa giải tranh chấp giữa người tiêu dùng và tổ chức, cá nhân kinh doanh bao gồm:
...
{n:64,name:'Hòa giải viên',kw:['kNTD','kTCC'],
full:`Hòa giải viên hòa giải tranh chấp giữa người tiêu dùng và tổ chức, cá nhân kinh doanh bao gồm:
...
{n:65,name:'Kết quả hòa giải',kw:[],
full:`1. Khi đạt được kết quả hòa giải thành, các bên lập văn bản về kết quả hòa giải thành.
...
{n:66,name:'Thực hiện và công nhận kết quả hòa giải thành',kw:[],
full:`1. Các bên tham gia hòa giải có trách nhiệm thực hiện kết quả hòa giải thành trong thời hạn đã thỏa thuận trong văn bản về kết quả hòa giải thành.
...
{n:67,name:'Hiệu lực của điều khoản trọng tài',kw:['kNTD','kTCC'],
full:`1. Tổ chức, cá nhân kinh doanh phải thông báo về điều khoản trọng tài trước khi giao kết hợp đồng và được người tiêu dùng chấp thuận.
...
{n:68,name:'Trình tự, thủ tục giải quyết tranh chấp tại trọng tài',kw:[],
full:`Trình tự, thủ tục giải quyết tranh chấp tại trọng tài được thực hiện theo quy định của pháp luật về trọng tài thương mại.`},

{n:69,name:'Nghĩa vụ chứng minh',kw:['kNTD','kTCC'],
full:`1. Người tiêu dùng có nghĩa vụ cung cấp chứng cứ và chứng minh để bảo vệ quyền, lợi ích hợp pháp của mình theo quy định của pháp luật, trừ việc chứng minh lỗi của tổ chức, cá nhân kinh doanh.
...
{n:70,name:'Vụ án dân sự về bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
...
{n:71,name:'Án phí đối với vụ án dân sự về bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
full:`1. Án phí đối với vụ án dân sự về bảo vệ quyền lợi người tiêu dùng được thực hiện theo quy định của pháp luật về án phí, lệ phí Tòa án và quy định của Luật này.
...
{n:72,name:'Công khai thông tin về vụ án dân sự về bảo vệ quyền lợi người tiêu dùng vì lợi ích công cộng do tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng khởi kiện',kw:['kNTD'],
full:`1. Tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng khởi kiện vụ án dân sự về bảo vệ quyền lợi người tiêu dùng vì lợi ích công cộng có trách nhiệm công khai thông báo thụ lý vụ án của Tòa án về việc khởi kiện trong thời hạn 07 ngày làm việc kể từ ngày Tòa án thụ lý.
...
{n:73,name:'Tiền bồi thường thiệt hại trong vụ án dân sự về bảo vệ quyền lợi người tiêu dùng vì lợi ích công cộng do tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng khởi kiện',kw:['kNTD'],
full:`1. Tiền bồi thường thiệt hại và đối tượng thụ hưởng trong vụ án dân sự về bảo vệ quyền lợi người tiêu dùng vì lợi ích công cộng do tổ chức xã hội tham gia bảo vệ quyền lợi người tiêu dùng khởi kiện được thực hiện theo bản án, quyết định của Tòa án.
...
{n:74,name:'Trách nhiệm quản lý nhà nước về bảo vệ quyền lợi người tiêu dùng',kw:['kNTD'],
full:`1. Chính phủ thống nhất quản lý nhà nước về bảo vệ quyền lợi người tiêu dùng.
...
{n:75,name:'Trách nhiệm của Bộ Công Thương',kw:['kNTD','kTDB'],
...
{n:76,name:'Trách nhiệm của các Bộ, cơ quan ngang Bộ',kw:['kNTD'],
full:`1. Thực hiện trách nhiệm quy định tại các khoản 1, 2, 3, 5, 6, 10 và 11 Điều 75 của Luật này trong lĩnh vực được phân công quản lý; phối hợp với Bộ Công Thương thực hiện trách nhiệm quy định tại khoản 4 và khoản 9 Điều 75 của Luật này.
...
{n:77,name:'Trách nhiệm của Ủy ban nhân dân các cấp',kw:['kNTD'],
full:`1. Ủy ban nhân dân cấp tỉnh có trách nhiệm sau đây:
...
{n:78,name:'Sửa đổi, bổ sung một số điều của Bộ luật Tố tụng dân sự số 92/2015/QH13 đã được sửa đổi, bổ sung một số điều theo Bộ luật số 45/2019/QH14, Luật số 59/2020/QH14 và Luật số 13/2022/QH15',kw:['kNTD'],
full:`1. Sửa đổi, bổ sung điểm b khoản 3 Điều 191 như sau:
...
{n:79,name:'Hiệu lực thi hành',kw:['kNTD'],
full:`1. Luật này có hiệu lực thi hành từ ngày 01 tháng 7 năm 2024.
...
{n:80,name:'Điều khoản chuyển tiếp',kw:['kNTD','kTCC'],
full:`1. Đối với giao dịch giữa tổ chức, cá nhân kinh doanh và người tiêu dùng được xác lập trước ngày Luật này có hiệu lực thi hành thì việc áp dụng pháp luật được thực hiện như sau:
...
KW:[
  {id:'kNTD',  lbl:'Người\ntiêu dùng', type:'kwc',
   terms:['người tiêu dùng']},
  {id:'kTCC',  lbl:'Tổ chức, cá\nnhân kinh doanh', type:'kwg',
   terms:['tổ chức, cá nhân kinh doanh']},
  {id:'kSPH',  lbl:'Sản phẩm, hàng\nhóa có khuyết tật', type:'kwg',
   terms:['sản phẩm, hàng hóa có khuyết tật']},
  {id:'kGDT',  lbl:'Giao\ndịch từ xa', type:'kwg',
   terms:['giao dịch từ xa']},
  {id:'kCCD',  lbl:'Cung cấp dịch\nvụ liên tục', type:'kwg',
   terms:['cung cấp dịch vụ liên tục']},
  {id:'kBHT',  lbl:'Bán hàng\ntrực tiếp', type:'kwg',
   terms:['bán hàng trực tiếp']},
  {id:'kNCẢ',  lbl:'Người có\nảnh hưởng', type:'kwg',
   terms:['người có ảnh hưởng']},
  {id:'kTDB',  lbl:'Tiêu dùng\nbền vững', type:'kwg',
   terms:['tiêu dùng bền vững']},
],
